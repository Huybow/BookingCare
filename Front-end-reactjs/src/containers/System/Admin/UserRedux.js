...
class UserRedux extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        //moi lan render => didupdate
        //check hien tai(this) va qua khu(previous)
        //qua khu la 1 mang rong con hien tai la 1 mang co 3 phan tu
        //[0]  khac [3] => chay ham ben duoi
        //[3] [3]
    ...
    checkValidateInput = () => {
        ...
        for(let i = 0; i < arrCheck.length; i ++) {
            if (!this.state[arrCheck[i]]) {
                isValid = false;
                alert('This is required: ' + arrCheck[i])
                break;
            }
        }
        return isValid
    ...
    render() {
        ...
        let isGetPositions = this.props.isLoadingPosition;
        let isGetRoles = this.props.isLoadingRole;
        ...
        return (
            <div className="user-redux-container">
                <div className=" title">
                    <FormattedMessage id="manage-user.title-manage-user" />
                </div>
